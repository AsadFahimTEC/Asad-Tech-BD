...
interface DashboardDetailsClientProps {
  dashboardId: string;
}

export default function DashboardDetailsClient({ dashboardId }: DashboardDetailsClientProps) {
  void dashboardId;
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex gap-4 mb-6">
        {[("Events" as const), ("Reviews" as const)].map((section) => (
          <button
            key={section}
